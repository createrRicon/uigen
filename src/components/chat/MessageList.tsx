...
import { formatToolInvocation, formatCompletedToolInvocation } from "@/lib/tool-display";
                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const displayText = tool.state === "result" ? formatCompletedToolInvocation(tool) : formatToolInvocation(tool);
                            return (
